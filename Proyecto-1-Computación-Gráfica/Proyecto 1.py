...
def main():
    ...
    def ventana_parte_1():
        ...
        # Crear botones
        boton_triangulo = tk.Button(ventana_bresenham, text="Triángulo", command=lambda: parte_1.triangle_points(), height=3, width=20)
        boton_pentagono = tk.Button(ventana_bresenham, text="Pentágono", command=lambda: parte_1.pentagon_points(), height=3, width=20)
        boton_cls1 = tk.Button(ventana_bresenham, text="Limpiar Pantalla", command=lambda: parte_1.clear_screen(), height=2, width=15)
        ...
        boton_volver = tk.Button(ventana_bresenham, text="Volver", command=lambda: volver_a_ventana_principal(ventana_bresenham))
    ...
    def ventana_parte_2():
        ...
        # Crear botones
        boton_fill = tk.Button(ventana_floodfill, text="Rellenar figura", command=lambda: parte_2.draw_triangle(), height=3, width=20)
        boton_cls2 = tk.Button(ventana_floodfill, text="Limpiar Pantalla", command=lambda: parte_2.clear_screen_2(), height=2, width=15)
        ...
        # Agregar un botón para volver a la ventana principal
        boton_volver = tk.Button(ventana_floodfill, text="Volver", command=lambda: volver_a_ventana_principal(ventana_floodfill))
        boton_volver.place(x=10, y=5)
    ...
    def ventana_parte_3():
        ...
        # Crear botones
        boton_crear = tk.Button(ventana_traslacion, text="Crear Figura", command=lambda: parte_3.triangle_points2(), height=3, width=20)
        boton_cls3 = tk.Button(ventana_traslacion, text="Limpiar Pantalla", command=lambda: parte_1.clear_screen(), height=2, width=15)
        ...
        # Agregar un botón para volver a la ventana principal
        boton_volver = tk.Button(ventana_traslacion, text="Volver", command=lambda: volver_a_ventana_principal(ventana_traslacion))
        boton_volver.place(x=10, y=5)
